...
import { StadiumCamera } from '../core/camera'
import { getAnim } from '../data/anim-data'
import { Scene } from '../core/scene'
import { Game } from '../game'
import { makeFloor, planeMesh } from '../util/mesh-util'
...
export class FieldTest extends Scene {
  ...
  constructor (game:Game) {
    ...
    const floor = this.makeMesh(makeFloor(0, 0, 100, 32, 0))
  ...
  update() {
    ...
    const copy = vec3.copy(this.animGuy.pos)
    this.cam.at = vec3.create(12, 0, copy[2])
